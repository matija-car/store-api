    ...
    return (
        <footer className="border-t border-burgundy-dark bg-burgundy px-5 py-12 text-cream sm:px-8">
            <div className="mx-auto grid max-w-7xl gap-10 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div><p className="mb-3 text-xs font-bold uppercase tracking-widest text-gold">Informacije</p><Link to="/sigurna-kupnja" className="block text-sm text-cream/70 hover:text-white">Sigurna kupnja</Link><Link to="/dostava-i-preuzimanje" className="mt-2 block text-sm text-cream/70 hover:text-white">Dostava i preuzimanje</Link><Link to="/uvjeti-poslovanja" className="mt-2 block text-sm text-cream/70 hover:text-white">Uvjeti poslovanja</Link><Link to="/privatnost" className="mt-2 block text-sm text-cream/70 hover:text-white">Privatnost</Link><Link to="/autorsko-djelo" className="mt-2 block text-sm text-cream/70 hover:text-white">Autorsko djelo</Link></div>
