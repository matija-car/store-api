...
| `SPRING_DATASOURCE_URL` | Railway MySQL JDBC URL beginning with `jdbc:mysql://`, using the private database connection. |
...
| `SPRING_DATASOURCE_DRIVER` | `com.mysql.cj.jdbc.Driver` (the application property name). |
| `SPRING_DATASOURCE_DRIVER_CLASS_NAME` | `com.mysql.cj.jdbc.Driver` if your deployment platform exposes Spring's conventional alias. |
